...
#define G_UC_APPLY_DEF_REG_CONFIG		1
 #define G_UC_SAVE_DEF_REG_CONFIG		 2
 #define G_UC_SET_REG_CONFIG	3
 #define G_UC_APPLY_MAXI_REG_CONFIG	7
 #define G_UC_SAVE_MAXI_REG_CONFIG	8
#define G_UC_APPLY_MINI_REG_CONFIG 9
 #define G_UC_SAVE_MINI_REG_CONFIG 10
